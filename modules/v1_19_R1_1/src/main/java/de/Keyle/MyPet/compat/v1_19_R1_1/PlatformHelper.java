...
import de.Keyle.MyPet.compat.v1_19_R1_1.util.inventory.ItemStackNBTConverter;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public void strikeLightning(Location loc, float distance) {
        ...
        world.getCraftServer()
                ...
                .getPlayerList()
                .broadcast(null, loc.getX(), loc.getY(), loc.getZ(), distance, world.dimension(),
                        new ClientboundSoundPacket(SoundEvents.LIGHTNING_BOLT_THUNDER, SoundSource.WEATHER, loc.getX(), loc.getY(), loc.getZ(), distance, 1F, 1));
    }
