...
public abstract class EntityMyPet extends EntityInsentient implements MyPetMinecraftEntity {
    ...
    public void movementTick() {
        ...
        if (this.bc > 0) {
            double newX = this.locX() + (this.bd - this.locX()) / (double) this.bc;
            double newY = this.locY() + (this.be - this.locY()) / (double) this.bc;
            double newZ = this.locZ() + (this.bf - this.locZ()) / (double) this.bc;
