...
package de.Keyle.MyPet.compat.v1_15_R1;
...
import de.Keyle.MyPet.compat.v1_15_R1.util.inventory.ItemStackNBTConverter;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public Boolean canSpawn(Location loc, AxisAlignedBB bb) {
        net.minecraft.server.v1_15_R1.World mcWorld = ((CraftWorld) loc.getWorld()).getHandle();
        return getBlockBBsInBB(mcWorld, bb).isEmpty() && !mcWorld.containsLiquid(bb);
    }

    @SuppressWarnings("unchecked")
    public List getBlockBBsInBB(net.minecraft.server.v1_15_R1.World world, AxisAlignedBB axisalignedbb) {
    ...
    public TagCompound entityToTag(Entity bukkitEntity) {
        net.minecraft.server.v1_15_R1.Entity entity = ((CraftEntity) bukkitEntity).getHandle();
    ...
    public Entity getEntity(int id, World world) {
        net.minecraft.server.v1_15_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(id);
    ...
    public net.minecraft.server.v1_15_R1.World getWorldNMS(World world) {
