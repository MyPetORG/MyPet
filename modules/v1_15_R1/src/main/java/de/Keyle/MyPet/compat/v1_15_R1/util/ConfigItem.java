...
package de.Keyle.MyPet.compat.v1_15_R1.util;

import de.Keyle.MyPet.MyPetApi;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.api.util.inventory.material.MaterialHolder;
import de.Keyle.MyPet.compat.v1_15_R1.util.inventory.ItemStackComparator;
...
public class ConfigItem extends de.Keyle.MyPet.api.util.ConfigItem {
    ...
    public boolean compare(Object o) {
        net.minecraft.server.v1_15_R1.ItemStack compareItem = (net.minecraft.server.v1_15_R1.ItemStack) o;
    ...
    public void load(MaterialHolder material, String data) {
        ...
        net.minecraft.server.v1_15_R1.ItemStack is = new net.minecraft.server.v1_15_R1.ItemStack(item, 1);
