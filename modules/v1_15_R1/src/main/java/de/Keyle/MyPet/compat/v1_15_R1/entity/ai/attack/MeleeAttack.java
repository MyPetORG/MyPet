...
package de.Keyle.MyPet.compat.v1_15_R1.entity.ai.attack;
...
public class MeleeAttack implements AIGoal {
    ...
    public void tick() {
        ...
        if (this.petEntity.g(targetEntity.locX(), targetEntity.getBoundingBox().minY, targetEntity.locZ()) - (targetEntity.getHeight() * (2. / 3.)) <= this.range && this.ticksUntilNextHitLeft-- <= 0) {
