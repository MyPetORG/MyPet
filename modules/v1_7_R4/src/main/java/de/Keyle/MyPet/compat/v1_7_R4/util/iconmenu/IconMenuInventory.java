/*
 * This file is part of mypet-compat-v1_7_R4
 *
 * Copyright (C) 2011-2016 Keyle
 * mypet-compat-v1_7_R4 is licensed under the GNU Lesser General Public License.
 *
 * mypet-compat-v1_7_R4 is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * mypet-compat-v1_7_R4 is distributed in the hope that it will be useful,
...
package de.Keyle.MyPet.compat.v1_7_R4.util.iconmenu;

import de.Keyle.MyPet.api.Util;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.api.util.inventory.IconMenu;
import de.Keyle.MyPet.api.util.inventory.IconMenuItem;
import de.Keyle.MyPet.compat.v1_7_R4.util.inventory.CustomInventory;
