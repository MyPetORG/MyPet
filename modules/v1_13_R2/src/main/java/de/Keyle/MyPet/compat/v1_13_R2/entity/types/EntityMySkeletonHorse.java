...
public class EntityMySkeletonHorse extends EntityMyPet implements IJumpable {
    ...
    protected static final DataWatcherObject<Boolean> ageWatcher = DataWatcher.a(EntityMySkeletonHorse.class, DataWatcherRegistry.i);
    ...
    protected static final DataWatcherObject<Optional<UUID>> ownerWatcher = DataWatcher.a(EntityMySkeletonHorse.class, DataWatcherRegistry.o);

    int soundCounter = 0;
    int rearCounter = -1;

    public EntityMySkeletonHorse(World world, MyPet myPet) {
        super(EntityTypes.SKELETON_HORSE, world, myPet);
    }
