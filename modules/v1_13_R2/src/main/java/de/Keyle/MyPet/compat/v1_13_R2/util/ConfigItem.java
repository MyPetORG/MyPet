...
public class ConfigItem extends de.Keyle.MyPet.api.util.ConfigItem {
    ...
    public void load(String data) {
        ...
        net.minecraft.server.v1_13_R2.ItemStack is;
        ...
        is = new net.minecraft.server.v1_13_R2.ItemStack(item, 1);
        ...
        if (splitData.length >= 2) {
            ...
            if (Util.isInt(dataString)) {
                is.setDamage(Integer.parseInt(dataString));
            }
        }
        ...
        if (splitData.length == 3) {
            ...
            if (nbtString.startsWith("{")) {
                try {
                    ...
                    MyPetApi.getLogger().warning(item.getName() + " " + is.getDamage() + nbtString);
                }
                if (nbtBase != null) {
