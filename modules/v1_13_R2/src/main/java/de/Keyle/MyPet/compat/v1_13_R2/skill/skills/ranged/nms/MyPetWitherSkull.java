...
package de.Keyle.MyPet.compat.v1_13_R2.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.compat.v1_13_R2.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v1_13_R2.skill.skills.ranged.bukkit.CraftMyPetWitherSkull;
...
public class MyPetWitherSkull extends EntityWitherSkull implements EntityMyPetProjectile {
    ...
    public CraftEntity getBukkitEntity() {
        if (this.bukkitEntity == null) {
            this.bukkitEntity = new CraftMyPetWitherSkull(this.world.getServer(), this);
        }
