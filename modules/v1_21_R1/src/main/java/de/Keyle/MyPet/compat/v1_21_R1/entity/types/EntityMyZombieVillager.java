...
public class EntityMyZombieVillager extends EntityMyPet {
	...
	public void updateVisuals() {
		...
		VillagerProfession profession = BuiltInRegistries.VILLAGER_PROFESSION.get(ResourceLocation.tryParse(professionKey));
		VillagerType type = BuiltInRegistries.VILLAGER_TYPE.get(ResourceLocation.tryParse(getMyPet().getType().getKey())); //TODO
