...
public class CraftMyPetPart extends CraftEntity implements MyPetBukkitPart {
    ...
    public CraftMyPetPart(CraftServer server, de.Keyle.MyPet.compat.v1_20_R1.entity.EntityMyPetPart entityMyPet) {
    ...
    @Override
    public de.Keyle.MyPet.compat.v1_20_R1.entity.EntityMyPetPart getHandle() {
        return petEntity;
    }
