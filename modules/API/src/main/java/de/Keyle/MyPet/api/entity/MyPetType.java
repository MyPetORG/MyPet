...
public enum MyPetType {
    ...
    Donkey("DONKEY", 31, MyDonkey.class),
    ElderGuardian("ELDER_GUARDIAN", 4, MyElderGuardian.class),
    ...
    SkeletonHorse("SKELETON_HORSE", 28, MySkeletonHorse.class),
    ...
    Stray("STRAY", 6, MyStray.class),
    Witch("WITCH", 66, MyWitch.class),
    Wither("WITHER", 64, MyWither.class, "WitherBoss"),
    WitherSkeleton("WITHER_SKELETON", 5, MyWitherSkeleton.class),
    ...
    ZombieHorse("ZOMBIE_HORSE", 29, MyZombieHorse.class),
    ZombieVillager("ZOMBIE_VILLAGER", 27, MyZombieVillager.class);
