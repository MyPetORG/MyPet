...
public class SkillTree {
    ...
    public void addSkillToLevel(int level, SkillInfo skill) {
        addSkillToLevel(level, skill, false);
    }

    public void addSkillToLevel(int level, SkillInfo skill, boolean top) {
        if (skill == null) {
            return;
        }
    ...
    public void addSkillToLevel(int level, List<SkillInfo> skillList) {
