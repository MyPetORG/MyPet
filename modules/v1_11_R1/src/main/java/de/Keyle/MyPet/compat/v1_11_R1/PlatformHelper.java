...
package de.Keyle.MyPet.compat.v1_11_R1;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public Boolean canSpawn(Location loc, AxisAlignedBB bb) {
        net.minecraft.server.v1_11_R1.World mcWorld = ((CraftWorld) loc.getWorld()).getHandle();
    ...
    public net.minecraft.server.v1_11_R1.World getWorldNMS(World world) {
