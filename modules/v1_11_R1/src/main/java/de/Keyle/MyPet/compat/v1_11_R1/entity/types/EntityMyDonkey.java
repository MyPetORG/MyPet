...
public class EntityMyDonkey extends EntityMyPet implements IJumpable {
    ...
    protected static final DataWatcherObject<Boolean> AGE_WATCHER = DataWatcher.a(EntityMyDonkey.class, DataWatcherRegistry.h);
    protected static final DataWatcherObject<Byte> SADDLE_WATCHER = DataWatcher.a(EntityMyDonkey.class, DataWatcherRegistry.a);
    protected static final DataWatcherObject<Optional<UUID>> OWNER_WATCHER = DataWatcher.a(EntityMyDonkey.class, DataWatcherRegistry.m);
    protected static final DataWatcherObject<Boolean> CHEST_WATCHER = DataWatcher.a(EntityMyDonkey.class, DataWatcherRegistry.h);
