...
public class MyAxolotl extends MyPet implements de.Keyle.MyPet.api.entity.types.MyAxolotl {
    ...
    protected Type axolotlType = Type.Wild;
    ...
    public TagCompound writeExtendedInfo() {
        ...
        info.getCompoundData().put("AxolotlType", new TagInt(getType().ordinal()));
        return info;
    }
    ...
    public void readExtendedInfo(TagCompound info) {
        ...
        if (info.containsKey("AxolotlType")) {
            setType(Type.values()[info.getAs("AxolotlType", TagInt.class).getIntData()]);
        }
    }
