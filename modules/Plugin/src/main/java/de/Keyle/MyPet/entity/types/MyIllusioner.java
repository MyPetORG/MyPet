...
public class MyIllusioner extends MyPet implements de.Keyle.MyPet.api.entity.types.MyIllusioner {
    ...
    public String toString() {
        return "MyIllusioner{owner=" + getOwner().getName() + ", name=" + ChatColor.stripColor(petName) + ", exp=" + experience.getExp() + "/" + experience.getRequiredExp() + ", lv=" + experience.getLevel() + ", status=" + status.name() + ", skilltree=" + (skilltree != null ? skilltree.getName() : "-") + ", worldgroup=" + worldGroup + "}";
    }
}