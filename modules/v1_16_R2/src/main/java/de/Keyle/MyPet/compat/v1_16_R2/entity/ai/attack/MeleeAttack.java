...
public class MeleeAttack implements AIGoal {
    ...
    public void tick() {
        ...
        if (this.petEntity.h(targetEntity.locX(), targetEntity.getBoundingBox().minY, targetEntity.locZ()) - (targetEntity.getHeight() * (2. / 3.)) <= this.range && this.ticksUntilNextHitLeft-- <= 0) {
