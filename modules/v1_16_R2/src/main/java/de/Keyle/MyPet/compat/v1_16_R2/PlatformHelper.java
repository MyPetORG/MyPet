...
package de.Keyle.MyPet.compat.v1_16_R2;
...
import de.Keyle.MyPet.compat.v1_16_R2.util.inventory.ItemStackNBTConverter;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public Boolean canSpawn(Location loc, AxisAlignedBB bb) {
        net.minecraft.server.v1_16_R2.World mcWorld = ((CraftWorld) loc.getWorld()).getHandle();
        return getBlockBBsInBB(mcWorld, bb).isEmpty() && !mcWorld.containsLiquid(bb);
    }

    public List getBlockBBsInBB(net.minecraft.server.v1_16_R2.World world, AxisAlignedBB axisalignedbb) {
    ...
    public TagCompound entityToTag(Entity bukkitEntity) {
        net.minecraft.server.v1_16_R2.Entity entity = ((CraftEntity) bukkitEntity).getHandle();
    ...
    public Entity getEntity(int id, World world) {
        net.minecraft.server.v1_16_R2.Entity e = ((CraftWorld) world).getHandle().getEntity(id);
    ...
    public net.minecraft.server.v1_16_R2.World getWorldNMS(World world) {
