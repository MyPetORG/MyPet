...
public class CraftMyPet extends CraftMob implements MyPetBukkitEntity {
    ...
    private class FakeEquipment extends CraftEntityEquipment {
        ...
        public ItemStack getItemInMainHand() {
            return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R2.ItemStack.b);
        }
        ...
        public ItemStack[] getArmorContents() {
            ItemStack empty = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R2.ItemStack.b);
