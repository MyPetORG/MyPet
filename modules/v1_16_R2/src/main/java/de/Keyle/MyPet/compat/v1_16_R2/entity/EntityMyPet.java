...
import de.Keyle.MyPet.compat.v1_16_R2.PlatformHelper;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.attack.MeleeAttack;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.attack.RangedAttack;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.movement.*;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_16_R2.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_16_R2.entity.types.EntityMyHorse;
...
public abstract class EntityMyPet extends EntityInsentient implements MyPetMinecraftEntity {
    ...
    public EntityMyPet(World world, MyPet myPet) {
        super(((de.Keyle.MyPet.compat.v1_16_R2.entity.EntityRegistry) MyPetApi.getEntityRegistry()).getEntityType(myPet.getPetType()), world);
    ...
    public AttributeMapBase getAttributeMap() {
        if (attributeMap == null) {
            de.Keyle.MyPet.compat.v1_16_R2.entity.EntityRegistry entityRegistry = (EntityRegistry) MyPetApi.getEntityRegistry();
    ...
    @Override
    public net.minecraft.server.v1_16_R2.EntitySize a(EntityPose entitypose) {
        EntitySize es = this.getClass().getAnnotation(EntitySize.class);
        if (es != null) {
            float width = es.width();
            float height = java.lang.Float.isNaN(es.height()) ? width : es.height();
            return new net.minecraft.server.v1_16_R2.EntitySize(width, height, false);
        }
    ...
    public void movementTick() {
        ...
        if (this.aV > 0) {
            double newX = this.locX() + (this.bd - this.locX()) / (double) this.aV;
            double newY = this.locY() + (this.be - this.locY()) / (double) this.aV;
            double newZ = this.locZ() + (this.bf - this.locZ()) / (double) this.aV;
            double d3 = MathHelper.g(this.az - (double) this.yaw);
            this.yaw = (float) ((double) this.yaw + d3 / (double) this.aV);
            this.pitch = (float) ((double) this.pitch + (this.aT - (double) this.pitch) / (double) this.aV);
            --this.aV;
