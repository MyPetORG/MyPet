...
public class Backup {
    ...
    public Backup(File backupFile, File backupFolder) {
        ...
        Bukkit.getScheduler().runTaskTimerAsynchronously(MyPetApi.getPlugin(), new Runnable() {
            public void run() {
                createBackup();
            }
    ...
    public BukkitTask createAsyncBackup() {
        return Bukkit.getScheduler().runTaskAsynchronously(MyPetApi.getPlugin(), new Runnable() {
            public void run() {
                createBackup();
            }
        });
