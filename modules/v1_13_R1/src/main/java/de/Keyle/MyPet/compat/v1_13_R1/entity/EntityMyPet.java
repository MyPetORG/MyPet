...
package de.Keyle.MyPet.compat.v1_13_R1.entity;
...
import de.Keyle.MyPet.compat.v1_13_R1.PlatformHelper;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.attack.MeleeAttack;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.attack.RangedAttack;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.movement.*;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_13_R1.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_13_R1.entity.types.EntityMyHorse;
    ...
    public void updateNameTag() {
        try {
            if (getCustomNameVisible()) {
                ...
                super.setCustomName(CraftChatMessage.fromStringOrNull(Util.cutString(prefix + myPet.getPetName() + suffix, 64)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
