...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public void playParticleEffect(Location location, String effectName, float offsetX, float offsetY, float offsetZ, float speed, int count, int radius, de.Keyle.MyPet.api.compat.Compat<Object> data) {
        Particle effect = Particle.REGISTRY.get(new MinecraftKey(effectName));
    ...
    public Boolean canSpawn(Location loc, AxisAlignedBB bb) {
        net.minecraft.server.v1_13_R1.World mcWorld = ((CraftWorld) loc.getWorld()).getHandle();
        return getBlockBBsInBB(mcWorld, bb).isEmpty() && !mcWorld.containsLiquid(bb);
    }

    @SuppressWarnings("unchecked")
    public List getBlockBBsInBB(net.minecraft.server.v1_13_R1.World world, AxisAlignedBB axisalignedbb) {
        ...
        for (int x = minX; x <= maxX; x++) {
            for (int z = minZ; z <= maxZ; z++) {
                if (world.getChunkProvider().f(x >> 4, z >> 4)) {
    ...
    public TagCompound entityToTag(Entity bukkitEntity) {
        net.minecraft.server.v1_13_R1.Entity entity = ((CraftEntity) bukkitEntity).getHandle();
    ...
    public Entity getEntity(int id, World world) {
        net.minecraft.server.v1_13_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(id);
    ...
    public net.minecraft.server.v1_13_R1.World getWorldNMS(World world) {
    ...
    public String getLastDamageSource(LivingEntity e) {
        ...
        return ((ChatMessage) el.cr().getLocalizedDeathMessage(el)).h();
    }
