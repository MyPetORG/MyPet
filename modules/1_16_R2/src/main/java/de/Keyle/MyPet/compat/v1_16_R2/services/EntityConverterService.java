...
package de.Keyle.MyPet.compat.v1_16_R2.services;
                ...
                try {
                    ...
                    if (villagerTag.containsKey("Inventory")) {
                        ...
                        for (int i = 0; i < vanillaNBT.size(); ++i) {
                            net.minecraft.server.v1_16_R2.ItemStack itemstack = net.minecraft.server.v1_16_R2.ItemStack.a(vanillaNBT.getCompound(i));
