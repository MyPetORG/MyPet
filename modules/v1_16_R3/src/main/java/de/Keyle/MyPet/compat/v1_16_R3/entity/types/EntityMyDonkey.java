		...
		if (!blockdata.getMaterial().isLiquid()) {
			...
			if (this.isVehicle()) {
				...
				if (this.soundCounter > 5 && this.soundCounter % 3 == 0) {
					this.playSound(SoundEffects.ENTITY_HORSE_GALLOP, soundeffecttype.a() * 0.16F, soundeffecttype.b());
				} else if (this.soundCounter <= 5) {
					this.playSound(SoundEffects.ENTITY_HORSE_STEP_WOOD, soundeffecttype.a() * 0.16F, soundeffecttype.b());
				}
			} else if (!blockdata.getMaterial().isLiquid()) {
				this.soundCounter += 1;
				playSound(SoundEffects.ENTITY_HORSE_STEP_WOOD, soundeffecttype.a() * 0.16F, soundeffecttype.b());
			} else {
				playSound(SoundEffects.ENTITY_HORSE_STEP, soundeffecttype.a() * 0.16F, soundeffecttype.b());
			}
		}
	}
