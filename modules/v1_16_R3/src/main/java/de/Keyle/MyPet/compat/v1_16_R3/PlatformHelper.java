...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
	...
	@Override
	public TagCompound entityToTag(org.bukkit.entity.Entity bukkitEntity) {
	...
	@Override
	public void applyTagToEntity(TagCompound tag, org.bukkit.entity.Entity bukkitEntity) {
		net.minecraft.server.v1_16_R3.Entity entity = ((CraftEntity) bukkitEntity).getHandle();
	...
	@Override
	public void doPickupAnimation(org.bukkit.entity.Entity entity, org.bukkit.entity.Entity target) {
		int count = 1;
		if (target instanceof EntityItem) {
			count = ((EntityItem) target).getItemStack().getCount();
		}
		for (org.bukkit.entity.Entity p : target.getNearbyEntities(10, 10, 10)) {
	...
	@Override
	public org.bukkit.entity.Entity getEntity(int id, World world) {
