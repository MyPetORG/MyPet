...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public Entity getEntity(int id, World world) {
        net.minecraft.server.v1_9_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(id);
    ...
    public void strikeLightning(Location loc, float distance) {
        ...
        world.getServer()
                ...
                .getPlayerList()
                .sendPacketNearby(null, loc.getX(), loc.getY(), loc.getZ(), distance, world.dimension,
                        new PacketPlayOutNamedSoundEffect(SoundEffects.dh, SoundCategory.WEATHER, loc.getX(), loc.getY(), loc.getZ(), distance, 1F));
    }

    @Override
    public Entity getEntityByUUID(UUID uuid) {
        net.minecraft.server.v1_9_R1.Entity e = ((CraftServer) Bukkit.getServer()).getServer().a(uuid);
        return e != null ? e.getBukkitEntity() : null;
    }
