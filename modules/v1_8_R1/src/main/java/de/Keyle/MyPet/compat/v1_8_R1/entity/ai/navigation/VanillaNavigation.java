...
package de.Keyle.MyPet.compat.v1_8_R1.entity.ai.navigation;
...
public class VanillaNavigation extends AbstractNavigation {
    ...
    public void applyNavigationParameters() {
        ...
        ((EntityMyPet) this.entityMyPet).getAttributeInstance(GenericAttributes.d).setValue(parameters.speed() + parameters.speedModifier());
    }
}