...
public class ConfigItem extends de.Keyle.MyPet.api.util.ConfigItem {
    ...
    public boolean compare(Object o) {
        net.minecraft.server.v1_10_R1.ItemStack compareItem = (net.minecraft.server.v1_10_R1.ItemStack) o;
    ...
    public void load(MaterialHolder material, String data) {
        ...
        net.minecraft.server.v1_10_R1.ItemStack is = new net.minecraft.server.v1_10_R1.ItemStack(item, 1, material.getLegacyName().getData());
