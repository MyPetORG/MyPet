...
package de.Keyle.MyPet.compat.v1_10_R1;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public Boolean canSpawn(Location loc, AxisAlignedBB bb) {
        net.minecraft.server.v1_10_R1.World mcWorld = ((CraftWorld) loc.getWorld()).getHandle();
    ...
    public Entity getEntity(int id, World world) {
        net.minecraft.server.v1_10_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(id);
    ...
    public net.minecraft.server.v1_10_R1.World getWorldNMS(World world) {
    ...
    public void strikeLightning(Location loc, float distance) {
        ...
        world.getServer()
                ...
                .getPlayerList()
                .sendPacketNearby(null, loc.getX(), loc.getY(), loc.getZ(), distance, world.dimension,
                        new PacketPlayOutNamedSoundEffect(SoundEffects.dn, SoundCategory.WEATHER, loc.getX(), loc.getY(), loc.getZ(), distance, 1F));
    }

    @Override
    public Entity getEntityByUUID(UUID uuid) {
        net.minecraft.server.v1_10_R1.Entity e = ((CraftServer) Bukkit.getServer()).getServer().a(uuid);
        return e != null ? e.getBukkitEntity() : null;
    }
    ...
    public String getLastDamageSource(LivingEntity e) {
        ...
        return ((ChatMessage) el.bU().getLocalizedDeathMessage(el)).i();
    }
