...
package de.Keyle.MyPet.compat.v1_14_R1.entity.ai.attack;
    ...
    public void shootProjectile(EntityLiving target, float damage, Projectile projectile) {
        ...
        switch (projectile) {
            ...
            case LargeFireball: {
                ...
                largeFireball.locY = (entityMyPet.locY + entityMyPet.getHeight() / 2.0F + 0.5D);
            ...
            case SmallFireball: {
                ...
                smallFireball.locY = (entityMyPet.locY + entityMyPet.getHeight() / 2.0F + 0.5D);
            ...
            case WitherSkull: {
                ...
                witherSkull.locY = (entityMyPet.locY + entityMyPet.getHeight() / 2.0F + 0.5D);
            ...
            case DragonFireball: {
                ...
                dragonFireball.locY = (entityMyPet.locY + entityMyPet.getHeight() / 2.0F + 0.5D);
