...
public class LookAtPlayer implements AIGoal {
    ...
    @Override
    public void tick() {
        this.petEntity.getControllerLook().a(this.targetPlayer.locX, this.targetPlayer.locY + this.targetPlayer.getHeadHeight(), this.targetPlayer.locZ, petEntity.O(), this.petEntity.N());
