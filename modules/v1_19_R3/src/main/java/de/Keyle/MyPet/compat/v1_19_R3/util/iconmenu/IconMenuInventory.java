...
import de.Keyle.MyPet.compat.v1_19_R3.util.inventory.CustomInventory;
...
public class IconMenuInventory implements de.Keyle.MyPet.api.gui.IconMenuInventory {
    ...
    static {
        try {
            Class<?> craftMetaItemClass = Class.forName("org.bukkit.craftbukkit.v1_19_R3.inventory.CraftMetaItem");
