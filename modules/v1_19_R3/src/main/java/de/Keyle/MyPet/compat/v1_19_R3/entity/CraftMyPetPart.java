...
public class CraftMyPetPart extends CraftEntity implements MyPetBukkitPart {
    ...
    protected de.Keyle.MyPet.compat.v1_19_R3.entity.EntityMyPetPart petEntity;

    public CraftMyPetPart(CraftServer server, de.Keyle.MyPet.compat.v1_19_R3.entity.EntityMyPetPart entityMyPet) {
    ...
    @Override
    public de.Keyle.MyPet.compat.v1_19_R3.entity.EntityMyPetPart getHandle() {
        return petEntity;
    }
