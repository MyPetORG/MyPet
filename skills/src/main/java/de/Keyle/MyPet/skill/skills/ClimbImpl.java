...
import de.Keyle.MyPet.skill.upgrades.ClimbUpgrade;
import net.kyori.adventure.text.Component;

public class ClimbImpl extends AbstractSkill implements Climb {

    public static final SkillUpgrades UPGRADES = SkillUpgrades.of(Climb.class,
            UpgradeSchema.builder()
                    .bool("active").label("Active")
                    .build(), json -> new ClimbUpgrade()
    ...
    public Component[] getUpgradeMessage() {
        if (getActive().getValue()) {
            return new Component[]{
                    upgradeMessage("Message.Skill.Climb.Upgrade")
            };
        }
        return null;
    }
