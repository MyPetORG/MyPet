...
public class LumberjackUpgrade implements Upgrade<Lumberjack> {
    @Getter
    @Setter
    ...
    @Setter
    @Accessors(chain = true)
    protected UpgradeIntegerModifier logsModifier = null;

    @Override
    public void apply(Lumberjack skill) {
        ...
        skill.getLogs().addUpgrade(logsModifier);
    }

    @Override
    public void invert(Lumberjack skill) {
        ...
        skill.getLogs().removeUpgrade(logsModifier);
    }
}
