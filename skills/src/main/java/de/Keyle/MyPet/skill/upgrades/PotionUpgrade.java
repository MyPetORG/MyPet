...
public class PotionUpgrade implements Upgrade<Potion> {
    ...
    protected UpgradeBooleanModifier materialiseModifier = null;
    ...
    public void apply(Potion skill) {
        ...
        skill.getMaterialise().addUpgrade(materialiseModifier);
    }
    ...
    public void invert(Potion skill) {
        ...
        skill.getMaterialise().removeUpgrade(materialiseModifier);
    }
}
