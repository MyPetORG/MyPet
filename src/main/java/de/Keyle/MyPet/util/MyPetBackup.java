...
public class MyPetBackup
{
    ...
    public MyPetBackup(File backupFile, File backupFolder)
    {
        ...
        try
        {
            String lastBackup = MyPetUtil.readFileAsString(backupFolder.getAbsolutePath() + File.separator + "lastbackup");
            if (MyPetUtil.isLong(lastBackup))
            {
