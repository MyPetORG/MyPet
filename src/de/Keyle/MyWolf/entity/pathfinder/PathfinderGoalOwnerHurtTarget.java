    ...
    public boolean a()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                return !(this.target instanceof EntityHuman && !MyWolfUtil.canHurtFaction(MWolf.getOwner().getPlayer(), ((Player) ((EntityHuman) this.target).getBukkitEntity())) && !MyWolfUtil.getPVP(((EntityHuman) this.target).getBukkitEntity().getLocation()) && !MyWolfUtil.canHurtTowny(MWolf.getOwner().getPlayer(), ((Player) ((EntityHuman) this.target).getBukkitEntity()))) && this.a(this.target, false);
            }
        }
    }
