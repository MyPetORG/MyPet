...
public class EntityMyCow extends EntityMyPet
{
    public EntityMyCow(World world, MyPet myPet)
    {
        ...
        this.goalSelector.a(5, new PathfinderGoalFollowOwner(this, 0.3F, 5.0F, 2.0F, Control));
    ...
    {
        return MyCow.getStartHP() + (isTamed() && myPet.getSkillSystem().hasSkill("HP") ? myPet.getSkillSystem().getSkill("HP").getLevel() : 0);
    }
