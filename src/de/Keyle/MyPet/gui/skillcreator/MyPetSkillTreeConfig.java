...
public class MyPetSkillTreeConfig
{
    ...
    private static String[] myPetTypes = {"default", "CaveSpider", "Chicken", "Cow", "IronGolem", "Mooshroom", "Ocelot", "Pig", "PigZombie", "Wolf", "Sheep", "Slime", "Spider", "Skeleton", "Silverfish", "Villager", "Zombie"};
