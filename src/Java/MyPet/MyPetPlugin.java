...
import Java.MyPet.chatcommands.*;
import Java.MyPet.entity.types.InactiveMyPet;
...
import Java.MyPet.listeners.*;
import Java.MyPet.skill.MyPetExperience;
import Java.MyPet.skill.MyPetJSexp;
import Java.MyPet.skill.MyPetSkillSystem;
import Java.MyPet.skill.skills.*;
import Java.MyPet.util.*;
import Java.MyPet.util.Metrics.Graph;
import Java.MyPet.util.Metrics.Plotter;
import Java.MyPet.util.configuration.NBTConfiguration;
import Java.MyPet.util.configuration.YamlConfiguration;
import Java.MyPet.util.logger.DebugLogger;
...
public class MyPetPlugin extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        getCommand("petstop").setExecutor(new Java.MyPet.chatcommands.CommandStop());
        getCommand("petrelease").setExecutor(new CommandRelease());
        getCommand("mypet").setExecutor(new Java.MyPet.chatcommands.CommandHelp());
