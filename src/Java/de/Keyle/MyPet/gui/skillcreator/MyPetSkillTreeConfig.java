...
public class MyPetSkillTreeConfig
{
    ...
    private static String[] myPetTypes = {"default", "Bat", "CaveSpider", "Chicken", "Cow", "Creeper", "Enderman","IronGolem", "MagmaCube", "Mooshroom", "Ocelot", "Pig", "PigZombie", "Sheep", "Slime", "Spider", "Skeleton", "Silverfish", "Villager", "Wolf", "Zombie"};
