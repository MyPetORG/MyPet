...
package de.Keyle.MyPet.compat.v26_1_R1;
...
import de.Keyle.MyPet.compat.v26_1_R1.entity.EntityMyAquaticPet;
import de.Keyle.MyPet.compat.v26_1_R1.util.VillagerNbtIO;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public static final Field dragonPartsField = ReflectionUtil.getField(ServerLevel.class, "dragonParts");
    private static final RegistryAccess REGISTRY_ACCESS = CraftRegistry.getMinecraftRegistry();
    private static Method readParticleMethod = ReflectionUtil.getMethod(ParticleArgument.class,"readParticle", TagParser.class, StringReader.class, ParticleType.class, HolderLookup.Provider.class);
    ...
    public void playParticleEffect(Location location, String effectName, float offsetX, float offsetY, float offsetZ, float speed, int count, int radius, de.Keyle.MyPet.api.compat.Compat<Object> data) {
        ParticleType<?> effect = BuiltInRegistries.PARTICLE_TYPE.get(Identifier.tryParse(effectName)).get().value();
        ...
        try {
            if (bukkitEntity instanceof Villager || bukkitEntity instanceof WanderingTrader) {
                ...
                net.minecraft.world.level.storage.TagValueOutput output = net.minecraft.world.level.storage.TagValueOutput.createWithContext(
                    net.minecraft.util.ProblemReporter.DISCARDING, REGISTRY_ACCESS
                );
