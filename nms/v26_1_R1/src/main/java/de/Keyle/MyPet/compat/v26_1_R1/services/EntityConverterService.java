...
package de.Keyle.MyPet.compat.v26_1_R1.services;
...
import de.Keyle.MyPet.compat.v26_1_R1.util.VariantConverter;
import de.Keyle.MyPet.compat.v26_1_R1.util.inventory.ItemStackNBTConverter;
            ...
            if (villagerPet.hasOriginalData()) {
                ...
                try {
                    ...
                    if (villagerTag.containsKey("FoodLevel")) {
                        ...
                        ReflectionUtil.setFieldValue("foodLevel", entityVillager, (int) foodLevel);
                    }
                    ...
                    if (villagerTag.containsKey("LastRestock")) {
                        ...
                        ReflectionUtil.setFieldValue("lastRestockGameTime", entityVillager, lastRestock);
                    }
                    if (villagerTag.containsKey("LastGossipDecay")) {
                        ...
                        ReflectionUtil.setFieldValue("lastGossipDecayTime", entityVillager, lastGossipDecay);
                    }
                    if (villagerTag.containsKey("RestocksToday")) {
                        int restocksToday = villagerTag.getAs("RestocksToday", TagInt.class).getIntData();
                        ReflectionUtil.setFieldValue("numberOfRestocksToday", entityVillager, restocksToday);
                    }
                    ReflectionUtil.setFieldValue("assignProfessionWhenSpawned", entityVillager, true);
                } catch (Exception e) {
                    e.printStackTrace();
                }
