...
import de.Keyle.MyPet.compat.v26_1_R1.skill.skills.ranged.bukkit.CraftMyPetLlamaSpit;
    ...
    public void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity) {
                entity.hurtServer(this.level().getMinecraftWorld(), this.damageSources().mobProjectile(this, getShooter()), damage);
            }
        }
        this.discard();
    }
