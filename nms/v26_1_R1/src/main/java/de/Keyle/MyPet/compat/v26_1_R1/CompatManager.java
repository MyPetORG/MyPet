...
import de.Keyle.MyPet.compat.v26_1_R1.services.RepositoryMyPetConverterService;
...
public class CompatManager extends de.Keyle.MyPet.api.util.CompatManager implements Listener {
	...
	public void enable() {
        ...
        Bukkit.getServer().getPluginManager().registerEvents(new de.Keyle.MyPet.compat.v26_1_R1.listeners.RideInteractListener(), MyPetApi.getPlugin());
    }
}
