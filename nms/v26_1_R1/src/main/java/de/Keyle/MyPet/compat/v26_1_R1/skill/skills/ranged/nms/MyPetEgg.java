...
package de.Keyle.MyPet.compat.v26_1_R1.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.compat.v26_1_R1.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v26_1_R1.skill.skills.ranged.bukkit.CraftMyPetEgg;
...
public class MyPetEgg extends ThrownEgg implements EntityMyPetProjectile {
    ...
    public MyPetEgg(Level world, EntityMyPet entityLiving) {
        super(world, entityLiving, new ItemStack(Items.EGG));
    }
    ...
    protected void onHit(HitResult movingObjectPosition) {
        ...
        for (int i = 0; i < 8; ++i) {
            this.level().addParticle(new ItemParticleOption(ParticleTypes.ITEM, Items.LEATHER_BOOTS), this.getX(), this.getY(), this.getZ(), ((double) this.random.nextFloat() - 0.5D) * 0.08D, ((double) this.random.nextFloat() - 0.5D) * 0.08D, ((double) this.random.nextFloat() - 0.5D) * 0.08D);
        }
        discard();
    }
