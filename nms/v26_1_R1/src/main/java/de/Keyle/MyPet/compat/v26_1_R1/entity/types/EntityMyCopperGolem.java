...
public class EntityMyCopperGolem extends EntityMyPet {
	...
	public void updateVisuals() {
		...
		if (getMyPet().hasPoppy()) {
			...
			this.setItemSlot(net.minecraft.world.entity.animal.golem.CopperGolem.EQUIPMENT_SLOT_ANTENNA, nmsPoppy);
		} else {
			this.setItemSlot(net.minecraft.world.entity.animal.golem.CopperGolem.EQUIPMENT_SLOT_ANTENNA, net.minecraft.world.item.ItemStack.EMPTY);
		}
	}
