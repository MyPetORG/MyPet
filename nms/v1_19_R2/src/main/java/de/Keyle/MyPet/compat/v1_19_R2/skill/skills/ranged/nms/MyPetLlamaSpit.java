...
package de.Keyle.MyPet.compat.v1_19_R2.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.compat.v1_19_R2.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v1_19_R2.skill.skills.ranged.bukkit.CraftMyPetLlamaSpit;
    ...
    public void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity) {
                entity.hurt(DamageSource.indirectMobAttack(this, (LivingEntity) super.getOwner()), damage);
            }
        }
        this.discard();
    }
