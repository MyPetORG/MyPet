...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    protected void replaceCraftAttributes() {
        ...
        Field attributesField = ReflectionUtil.getField(LivingEntity.class, "attributes", "bQ"); // bQ = obfuscated name for 1.19.2
    ...
    public void travel(Vec3 vec3d) {
        ...
        if (getBukkitEntity().isUnderWater() && !this.rideableUnderWater()) {
