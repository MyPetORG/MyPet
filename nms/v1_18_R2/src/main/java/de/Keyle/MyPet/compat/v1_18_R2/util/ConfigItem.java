...
package de.Keyle.MyPet.compat.v1_18_R2.util;

import de.Keyle.MyPet.MyPetApi;
import de.Keyle.MyPet.compat.v1_18_R2.util.inventory.ItemStackComparator;
...
public class ConfigItem extends de.Keyle.MyPet.api.util.ConfigItem {
    ...
    public void load(String materialId, String data) {
        ResourceLocation key = new ResourceLocation(materialId);
