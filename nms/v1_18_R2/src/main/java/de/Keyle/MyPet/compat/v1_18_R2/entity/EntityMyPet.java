...
package de.Keyle.MyPet.compat.v1_18_R2.entity;
...
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.attack.MeleeAttack;
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.attack.RangedAttack;
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.movement.*;
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_18_R2.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_18_R2.entity.types.EntityMyDolphin;
import de.Keyle.MyPet.compat.v1_18_R2.entity.types.EntityMySeat;
...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    protected void replaceCraftAttributes() {
        ...
        Field attributesField = ReflectionUtil.getField(LivingEntity.class, "attributes", "bQ"); // bQ = obfuscated name for 1.18.2
    ...
    public InteractionResult handlePlayerInteraction(final net.minecraft.world.entity.player.Player entityhuman, InteractionHand enumhand, final ItemStack itemStack) {
        ...
        if (isMyPet() && myPet.getOwner().equals(entityhuman)) {
            ...
            if (!owner.isSneaking() && !Configuration.Misc.RIGHT_CLICK_COMMAND.isEmpty()) {
                ...
                command = command.replaceAll("%pet_level%", String.valueOf(myPet.getExperience().getLevel()));
