...
package de.Keyle.MyPet.compat.v1_18_R2.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.compat.v1_18_R2.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v1_18_R2.skill.skills.ranged.bukkit.CraftMyPetLlamaSpit;
    ...
    public void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity && owner instanceof LivingEntity livingOwner) {
                entity.hurt(DamageSource.indirectMobAttack(this, livingOwner), damage);
            }
        }
        this.discard();
    }
