...
import de.Keyle.MyPet.compat.v1_20_R1.PlatformHelper;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.attack.MeleeAttack;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.attack.RangedAttack;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.movement.*;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_20_R1.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_20_R1.entity.types.EntityMyDolphin;
import de.Keyle.MyPet.compat.v1_20_R1.entity.types.EntityMySeat;
...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    private static final Field jump = ReflectionUtil.getField(LivingEntity.class, "jumping", "bk");
    ...
    protected void replaceCraftAttributes() {
        ...
        Field attributesField = ReflectionUtil.getField(LivingEntity.class, "attributes", "bP"); // bP = obfuscated name for 1.20.1
