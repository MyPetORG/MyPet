...
package de.Keyle.MyPet.compat.v1_20_R2.services;
...
import de.Keyle.MyPet.compat.v1_20_R2.util.inventory.ItemStackNBTConverter;
            ...
            if (villagerPet.hasOriginalData()) {
                ...
                try {
                    ...
                    if (villagerTag.containsKey("FoodLevel")) {
                        ...
                        ReflectionUtil.setFieldValue("co", entityVillager, foodLevel);        // Field: foodLevel
                    }
                    ...
                    if (villagerTag.containsKey("LastRestock")) {
                        ...
                        ReflectionUtil.setFieldValue("ct", entityVillager, lastRestock);    //Field: lastRestock(Game)Time
                    }
                    ...
                    if (villagerTag.containsKey("RestocksToday")) {
                        ...
                        ReflectionUtil.setFieldValue("cu", entityVillager, restocksToday);        //Field: numberOfRestocksToday or restocksToday
                    }
                    ReflectionUtil.setFieldValue("cw", entityVillager, true); // Field: AssignProfessionWhenSpawned (natural?)
                } catch (Exception e) {
                    ErrorUtil.report(e);
                }
