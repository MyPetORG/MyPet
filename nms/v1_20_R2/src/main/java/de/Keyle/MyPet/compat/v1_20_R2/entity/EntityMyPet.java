...
import de.Keyle.MyPet.compat.v1_20_R2.PlatformHelper;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.attack.MeleeAttack;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.attack.RangedAttack;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.movement.*;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_20_R2.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_20_R2.entity.types.EntityMyDolphin;
import de.Keyle.MyPet.compat.v1_20_R2.entity.types.EntityMySeat;
...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    protected void replaceCraftAttributes() {
        ...
        Field attributesField = ReflectionUtil.getField(LivingEntity.class, "attributes", "bO"); // bO = obfuscated name for 1.20.2
