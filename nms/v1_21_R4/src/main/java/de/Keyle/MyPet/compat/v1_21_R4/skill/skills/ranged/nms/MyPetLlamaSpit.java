...
import de.Keyle.MyPet.compat.v1_21_R4.skill.skills.ranged.bukkit.CraftMyPetLlamaSpit;
    ...
    public void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity && owner instanceof LivingEntity livingOwner) {
                entity.hurtServer(this.level().getMinecraftWorld(), this.damageSources().mobProjectile(this, livingOwner), damage);
            }
        }
        this.discard();
    }
