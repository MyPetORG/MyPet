...
import de.Keyle.MyPet.compat.v1_21_R1.skill.skills.ranged.bukkit.CraftMyPetEnderPearl;
...
public class MyPetEnderPearl extends ThrownEnderpearl implements EntityMyPetProjectile {
    ...
    protected void onHit(HitResult movingObjectPosition) {
        ...
        for (int i = 0; i < 32; ++i) {
            ...
            Field portalParticleField = ReflectionUtil.getField(ParticleTypes.class,"ac");
