...
package de.Keyle.MyPet.compat.v1_19_R3.entity;
...
import de.Keyle.MyPet.compat.v1_19_R3.entity.ai.movement.Float;
import de.Keyle.MyPet.compat.v1_19_R3.entity.ai.navigation.VanillaNavigation;
import de.Keyle.MyPet.compat.v1_19_R3.entity.ai.target.*;
import de.Keyle.MyPet.compat.v1_19_R3.entity.types.EntityMyDolphin;
import de.Keyle.MyPet.compat.v1_19_R3.entity.types.EntityMySeat;
...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    private static final Field jump = ReflectionUtil.getField(LivingEntity.class, "jumping", "bi");
    ...
    protected void replaceCraftAttributes() {
        ...
        Field attributesField = ReflectionUtil.getField(LivingEntity.class, "attributes", "bM"); // bM = obfuscated name for 1.19.3/1.19.4
