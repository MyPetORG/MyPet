...
public class EntityRegistry extends de.Keyle.MyPet.api.entity.EntityRegistry {
    ...
    protected void registerEntity(MyPetType type, DefaultedRegistry<EntityType<?>> entityRegistry) {
        Class<? extends EntityMyPet> entityClass = ReflectionUtil.getClass("de.Keyle.MyPet.compat.v1_19_R3.entity.types.EntityMy" + type.name()).asSubclass(EntityMyPet.class);
    ...
    public void registerEntityTypes() {
        ...
        Field intrusiveHolderCacheField = ReflectionUtil.getField(MappedRegistry.class, "intrusiveHolderCache", "m");
        MethodHandle ENTITY_REGISTRY_SETTER = ReflectionUtil.createStaticFinalSetter(BuiltInRegistries.class, "ENTITY_TYPE", "h");
