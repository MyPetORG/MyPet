...
package de.Keyle.MyPet.compat.v26_2_R1.entity.types;
...
import de.Keyle.MyPet.compat.v26_2_R1.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v26_2_R1.entity.ai.movement.EatGrass;
...
public class EntityMySheep extends EntityMyPet {
	...
	static {
		colorMap.put(DyeColor.WHITE, Blocks.WOOL.pick(DyeColor.WHITE));
		colorMap.put(DyeColor.ORANGE, Blocks.WOOL.pick(DyeColor.ORANGE));
		colorMap.put(DyeColor.MAGENTA, Blocks.WOOL.pick(DyeColor.MAGENTA));
		colorMap.put(DyeColor.LIGHT_BLUE, Blocks.WOOL.pick(DyeColor.LIGHT_BLUE));
		colorMap.put(DyeColor.YELLOW, Blocks.WOOL.pick(DyeColor.YELLOW));
		colorMap.put(DyeColor.LIME, Blocks.WOOL.pick(DyeColor.LIME));
		colorMap.put(DyeColor.PINK, Blocks.WOOL.pick(DyeColor.PINK));
		colorMap.put(DyeColor.GRAY, Blocks.WOOL.pick(DyeColor.GRAY));
		colorMap.put(DyeColor.LIGHT_GRAY, Blocks.WOOL.pick(DyeColor.LIGHT_GRAY));
		colorMap.put(DyeColor.CYAN, Blocks.WOOL.pick(DyeColor.CYAN));
		colorMap.put(DyeColor.PURPLE, Blocks.WOOL.pick(DyeColor.PURPLE));
		colorMap.put(DyeColor.BLUE, Blocks.WOOL.pick(DyeColor.BLUE));
		colorMap.put(DyeColor.BROWN, Blocks.WOOL.pick(DyeColor.BROWN));
		colorMap.put(DyeColor.GREEN, Blocks.WOOL.pick(DyeColor.GREEN));
		colorMap.put(DyeColor.RED, Blocks.WOOL.pick(DyeColor.RED));
		colorMap.put(DyeColor.BLACK, Blocks.WOOL.pick(DyeColor.BLACK));
	}
	...
	public InteractionResult handlePlayerInteraction(Player entityhuman, InteractionHand enumhand, ItemStack itemStack) {
		...
		if (getOwner().equals(entityhuman) && itemStack != null && canUseItem()) {
			...
			if (dyeColor != null && dyeColor.ordinal() != getMyPet().getColor().ordinal() && !getMyPet().isSheared()) {
				getMyPet().setColor(org.bukkit.DyeColor.values()[dyeColor.ordinal()]);
