...
package de.Keyle.MyPet.compat.v1_21_R5.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.api.util.ErrorUtil;
import de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v1_21_R5.skill.skills.ranged.bukkit.CraftMyPetLargeFireball;
    ...
    protected void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity) {
                entity.hurtServer(this.level().getMinecraftWorld(), this.damageSources().fireball(this, super.getOwner()), damage);
            }
        }
        discard();
    }
