...
public class EntityMyCopperGolem extends EntityMyPet {
    ...
    public void updateVisuals() {
        ...
        if (getMyPet().hasPoppy()) {
            ...
            ItemStack nmsPoppy = org.bukkit.craftbukkit.inventory.CraftItemStack.asNMSCopy(bukkitPoppy);
            this.setItemSlot(net.minecraft.world.entity.animal.golem.CopperGolem.EQUIPMENT_SLOT_ANTENNA, nmsPoppy);
        } else {
            this.setItemSlot(net.minecraft.world.entity.animal.golem.CopperGolem.EQUIPMENT_SLOT_ANTENNA, ItemStack.EMPTY);
        }
    }
