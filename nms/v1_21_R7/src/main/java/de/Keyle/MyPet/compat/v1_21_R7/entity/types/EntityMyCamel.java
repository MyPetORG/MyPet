...
public class EntityMyCamel extends EntityMyPet {
    ...
    private static final EntityDataAccessor<Boolean> AGE_WATCHER = SynchedEntityData.defineId(EntityMyCamel.class, EntityDataSerializers.BOOLEAN);       // 16: AgeableMob baby
    protected static final EntityDataAccessor<Byte> SADDLE_CHEST_WATCHER = SynchedEntityData.defineId(EntityMyCamel.class, EntityDataSerializers.BYTE);  // 17: AbstractHorse flags
    public static final EntityDataAccessor<Boolean> DASH = SynchedEntityData.defineId(EntityMyCamel.class, EntityDataSerializers.BOOLEAN);               // 18: Camel dash
    public static final EntityDataAccessor<Long> LAST_POSE_CHANGE_TICK = SynchedEntityData.defineId(EntityMyCamel.class, EntityDataSerializers.LONG);    // 19: Camel last_pose_change_tick
    ...
    public long getPoseTime() {
        return this.level().getGameTime() - Math.abs(this.getEntityData().get(LAST_POSE_CHANGE_TICK));
    }
