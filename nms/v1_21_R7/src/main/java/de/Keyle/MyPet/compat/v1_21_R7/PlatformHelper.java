...
import org.bukkit.craftbukkit.v1_21_R7.util.UnsafeList;
...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public void applyTagToEntity(TagCompound tag, Entity bukkitEntity) {
        ...
        if (nbtData != null) {
            ...
            } else if (bukkitEntity instanceof net.minecraft.world.entity.npc.wanderingtrader.WanderingTrader) {
            	net.minecraft.world.entity.npc.wanderingtrader.WanderingTrader villager = (net.minecraft.world.entity.npc.wanderingtrader.WanderingTrader) entity;
                VillagerNbtIO.writeFrom(bukkitEntity);
            }
        }
    }
