...
import de.Keyle.MyPet.compat.v1_21_R7.services.RepositoryMyPetConverterService;
...
public class CompatManager extends de.Keyle.MyPet.api.util.CompatManager implements Listener {
	...
	public void enable() {
        ...
        Bukkit.getServer().getPluginManager().registerEvents(new de.Keyle.MyPet.compat.v1_21_R7.listeners.RideInteractListener(), MyPetApi.getPlugin());
    }
}
