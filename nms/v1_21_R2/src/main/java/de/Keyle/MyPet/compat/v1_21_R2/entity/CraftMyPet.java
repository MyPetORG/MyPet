...
import org.bukkit.craftbukkit.v1_21_R2.inventory.CraftEntityEquipment;
...
public class CraftMyPet extends CraftMob implements MyPetBukkitEntity {
	...
	protected de.Keyle.MyPet.compat.v1_21_R2.entity.EntityMyPet petEntity;
	protected CraftEntityEquipment fakeEquipment;

	public CraftMyPet(CraftServer server, de.Keyle.MyPet.compat.v1_21_R2.entity.EntityMyPet entityMyPet) {
	...
	@Override
	public de.Keyle.MyPet.compat.v1_21_R2.entity.EntityMyPet getHandle() {
		return petEntity;
	}
