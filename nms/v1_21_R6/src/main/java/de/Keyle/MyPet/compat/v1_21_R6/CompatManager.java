...
import de.Keyle.MyPet.compat.v1_21_R6.services.EggIconService;
import de.Keyle.MyPet.compat.v1_21_R6.services.EntityConverterService;
import de.Keyle.MyPet.compat.v1_21_R6.services.RepositoryMyPetConverterService;
...
public class CompatManager extends de.Keyle.MyPet.api.util.CompatManager implements Listener {
	...
	public void enable() {
        ...
        Bukkit.getServer().getPluginManager().registerEvents(new de.Keyle.MyPet.compat.v1_21_R6.listeners.RideInteractListener(), MyPetApi.getPlugin());
    }
}
