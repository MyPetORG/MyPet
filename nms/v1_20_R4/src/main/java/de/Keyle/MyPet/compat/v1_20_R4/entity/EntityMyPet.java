...
import de.Keyle.MyPet.compat.v1_20_R4.PlatformHelper;
import de.Keyle.MyPet.entity.ai.navigation.PaperNavigation;
import de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyDolphin;
import de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMySeat;
...
public abstract class EntityMyPet extends PathfinderMob implements MyPetMinecraftEntity {
    ...
    public void applySittingVisual(boolean sitting) {
        switch (this) {
            case de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyWolf w -> w.applySitting(sitting);
            case de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyCat c -> c.applySitting(sitting);
            case de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyCamel m -> m.applySitting(sitting);
            case de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyFox f -> f.updateActionsWatcher(1, sitting);
            case de.Keyle.MyPet.compat.v1_20_R4.entity.types.EntityMyPanda p -> p.updateActionsWatcher(8, sitting);
            default -> {}
        }
    }
