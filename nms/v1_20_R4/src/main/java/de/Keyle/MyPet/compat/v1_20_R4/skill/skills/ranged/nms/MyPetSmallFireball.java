...
package de.Keyle.MyPet.compat.v1_20_R4.skill.skills.ranged.nms;

import de.Keyle.MyPet.api.entity.skill.ranged.EntityMyPetProjectile;
import de.Keyle.MyPet.api.util.ErrorUtil;
import de.Keyle.MyPet.compat.v1_20_R4.entity.EntityMyPet;
import de.Keyle.MyPet.compat.v1_20_R4.skill.skills.ranged.bukkit.CraftMyPetSmallFireball;
    ...
    protected void onHit(HitResult movingObjectPosition) {
        if (movingObjectPosition.getType() == HitResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity) {
                entity.hurt(this.damageSources().fireball(this, super.getOwner()), damage);
            }
        }
        discard();
    }
