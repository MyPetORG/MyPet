...
$1_16_R2_S = "https://cdn.getbukkit.org/spigot/spigot-1.16.2.jar"
...
& mvn install:install-file -D"file=.\dl\1_16_R2_S.jar" -D"version=1.16.2-R0.1-SNAPSHOT" -D"groupId=org.spigotmc" -D"artifactId=spigot" -D"packaging=jar"
