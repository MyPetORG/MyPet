...
public class MyZombieNautilus extends MyPet implements MyPetEquipment, MyPetAmphibiousEntity, MyPetSunSensitive {

    public MyZombieNautilus(MyPetPlayer petOwner) {
        super(petOwner);
    }
