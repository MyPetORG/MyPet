...
@LeashFlagName("CanBreed")
public class CanBreedFlag implements LeashFlag {
    @Override
    ...
    public Component getMissingMessage(Player player, LivingEntity entity, double damage, Settings settings) {
        return Translation.getComponent("Message.Command.CaptureHelper.Requirement.CanBreed", player);
    }
}
