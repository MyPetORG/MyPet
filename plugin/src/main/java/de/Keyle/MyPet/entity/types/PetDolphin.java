...
@ShopInfo
@DefaultInfo(food = {Material.COD}, flySpeed = 2.6432D)
public class PetDolphin extends PetImpl implements PetBaby, PetAquaticEntity {
    ...
    public PetDolphin(MyPetPlayer petOwner) {
        super(petOwner);
    }
}
