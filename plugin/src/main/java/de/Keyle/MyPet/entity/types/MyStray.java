...
public class MyStray extends MyPet implements de.Keyle.MyPet.api.entity.types.MyStray {
    protected Map<EquipmentSlot, ItemStack> equipment = new HashMap<>();

    public MyStray(MyPetPlayer petOwner) {
        super(petOwner);
    }
    ...
    public String toString() {
        return "MyStray{owner=" + getOwner().getName() + ", name=" + ChatColor.stripColor(petName) + ", exp=" + experience.getExp() + "/" + experience.getRequiredExp() + ", lv=" + experience.getLevel() + ", status=" + status.name() + ", skilltree=" + (skilltree != null ? skilltree.getName() : "-") + ", worldgroup=" + worldGroup + "}";
    }
}