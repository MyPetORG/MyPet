...
public final class PetGoalKey {
    ...
    /** Autonomously scales a wall when the pet's destination is up and over it (Climb skill). */
    public static final GoalKey<Mob> CLIMB = GoalKey.of(Mob.class, new NamespacedKey("mypet", "climb"));
