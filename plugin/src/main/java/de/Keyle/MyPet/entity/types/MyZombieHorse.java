...
public class MyZombieHorse extends MyPet implements de.Keyle.MyPet.api.entity.types.MyZombieHorse {
    ...
    public MyPetType getPetType() {
        return MyPetType.ZombieHorse;
    }

    @Override
    public String toString() {
        return "MyZombieHorse{owner=" + getOwner().getName() + ", name=" + ChatColor.stripColor(petName) + ", exp=" + experience.getExp() + "/" + experience.getRequiredExp() + ", lv=" + experience.getLevel() + ", status=" + status.name() + ", skilltree=" + (skilltree != null ? skilltree.getName() : "-") + ", worldgroup=" + worldGroup + ", saddle=" + saddle + "}";
    }
}