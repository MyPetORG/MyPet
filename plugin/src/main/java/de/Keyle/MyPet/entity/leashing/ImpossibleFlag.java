...
@LeashFlagName("Impossible")
public class ImpossibleFlag implements LeashFlag {
    @Override
    ...
    public Component getMissingMessage(Player player, LivingEntity entity, double damage, Settings settings) {
        return Translation.getComponent("Message.Command.CaptureHelper.Requirement.Impossible", player);
    }
}
